...
android {
    namespace = "kr.co.hconnect.polihealth_samsung_health_data_sdk"
    compileSdk = 36
...
dependencies {
    ...
    // Health Data SDK 타입은 공개 API(PolihealthSamsungHealthDataSdk)로 노출하지 않으므로 api가 아닌 implementation으로 캡슐화한다.
    ...
    publishing {
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = "polihealth-samsung-health-data-sdk"
                version = libVersion
            }
        }
