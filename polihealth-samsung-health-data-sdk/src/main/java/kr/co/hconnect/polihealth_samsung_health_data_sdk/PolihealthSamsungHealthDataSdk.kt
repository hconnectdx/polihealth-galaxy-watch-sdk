...
/**
 * polihealth-samsung-health-data-sdk 진입점.
 *
 * 삼성헬스 앱에 저장된 걸음수/심박수/산소포화도/피부온도를 직접 읽어온다.
 * 자세한 배경은 `polihealth-samsung-health-data-sdk/docs/samsung-health-integration.md` 참고.
 *
 * ## 사용 순서
 * ```kotlin
 ...
 * }
 * val steps = PolihealthSamsungHealthDataSdk.readHealthDataSteps(context, days = 7)
 ...
 * ```
 */
object PolihealthSamsungHealthDataSdk {
