...
include(":polihealth-samsung-health-data-sdk")


include(":polihealth-samsung-health-data-sdk-example")
...
//        maven { url 'https://jitpack.io' }
        ...
        // 실제 .aar 파일은 polihealth-samsung-health-data-sdk/libs/repo/... 에 직접 배치해야 한다
        // (polihealth-samsung-health-data-sdk/docs/samsung-health-integration.md 4절 참고).
        maven { url = uri(File(rootDir, "polihealth-samsung-health-data-sdk/libs/repo")) }
    }
}
