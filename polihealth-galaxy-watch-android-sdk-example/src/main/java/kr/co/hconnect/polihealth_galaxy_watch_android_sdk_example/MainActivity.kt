...
import kr.co.hconnect.polihealth_galaxy_watch_android_sdk_example.ui.theme.PolihealthGalaxyWatchSdkTheme
import kr.co.hconnect.polihealth_galaxy_watch_android_sdk_example.BuildConfig
...
class MainActivity : ComponentActivity() {
    ...
    private fun initSdk() {
        ...
        PolihealthGalaxyWatchAndroidSdk.setHealthOnUser(userSno = 999, userAge = 111)
...
fun MainScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Polihealth Galaxy Watch Android SDK Example") },
