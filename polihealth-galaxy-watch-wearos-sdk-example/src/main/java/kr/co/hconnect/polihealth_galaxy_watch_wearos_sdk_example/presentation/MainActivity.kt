...
import kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk_example.presentation.theme.PolihealthGalaxyWatchSdkTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun initSdk() {
        ...
        PolihealthGalaxyWatchWearOsSdk.setAlarmSlotMinutes(this, intArrayOf(1,21, 31, 42))
        PolihealthGalaxyWatchWearOsSdk.setAlarmSensorTypes(this, setOf(SensorType.ACC, SensorType.PPG_GREEN_25))

        sdkInitialized.value = true

        val slots = PolihealthGalaxyWatchWearOsSdk.getAlarmSlotMinutes(this).joinToString(",")
        val duration = PolihealthGalaxyWatchWearOsSdk.getMeasurementDuration(this) / 1000
    ...
    private fun startPeriodic() {
        if (!checkInit()) return
        val durationMs = PolihealthGalaxyWatchWearOsSdk.getMeasurementDuration(this)
        val slots = PolihealthGalaxyWatchWearOsSdk.getAlarmSlotMinutes(this)
        val types = PolihealthGalaxyWatchWearOsSdk.getAlarmSensorTypes(this)
    ...
    private fun scheduleAlarm() {
        ...
        val types = PolihealthGalaxyWatchWearOsSdk.getAlarmSensorTypes(this)
            ?: setOf(SensorType.ACC, SensorType.PPG_GREEN_25)
        val slots = PolihealthGalaxyWatchWearOsSdk.getAlarmSlotMinutes(this).joinToString(",")
        PolihealthGalaxyWatchWearOsSdk.schedulePeriodicAlarm(this, types)
...
fun MainScreen(
    ...
    val trackingState by PolihealthGalaxyWatchWearOsSdk.trackingState.collectAsState()
