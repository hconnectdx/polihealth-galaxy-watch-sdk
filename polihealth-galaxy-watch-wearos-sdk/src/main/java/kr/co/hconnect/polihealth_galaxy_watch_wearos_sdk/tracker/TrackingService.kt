...
import kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.R
...
class TrackingService : Service() {
    ...
    override fun onCreate() {
        ...
        trackerManager = PolihealthGalaxyWatchWearOsSdk.trackerManager
        trackerProcessor = PolihealthGalaxyWatchWearOsSdk.trackerProcessor

        val pm = getSystemService(Context.POWER_SERVICE) as PowerManager
        wakeLock = pm.newWakeLock(
            PowerManager.PARTIAL_WAKE_LOCK,
            "PolihealthGalaxyWatchWearOsSdk::CpuWakeLock"
    ...
    companion object {
        private const val CHANNEL_ID = "POLIHEALTH_GALAXY_WATCH_WEAROS_SDK_TRACKING_CHANNEL"
        private const val CHANNEL_NAME = "Polihealth Galaxy Watch WearOS SDK Tracking"
        private const val NOTIFICATION_ID = 1001

        const val ACTION_START = "kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.START"
        const val ACTION_START_ON_DEMAND = "kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.START_ON_DEMAND"
        const val ACTION_STOP_ON_DEMAND = "kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.STOP_ON_DEMAND"
