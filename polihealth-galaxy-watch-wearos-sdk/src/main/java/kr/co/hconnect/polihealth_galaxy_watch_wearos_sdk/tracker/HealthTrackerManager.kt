...
import kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.data.ACCData
import kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.data.ECG500Data
import kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.data.PPGGreen100Data
import kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.data.PPGGreen25Data
import kr.co.hconnect.polihealth_galaxy_watch_wearos_sdk.proto.*
import kotlin.coroutines.resume
import kotlin.coroutines.resumeWithException

class HealthTrackerManager : TrackerManager {
    ...
    override fun startECGTracking(
        service: HealthTrackingService,
        appContext: Context,
        onDataReceived: (List<ECG500Data>) -> Unit
    ) {
