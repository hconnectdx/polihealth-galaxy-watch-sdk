...
import kr.co.hconnect.samsung_server_sdk.health.HealthDataManager
 ...
 * 바로 사용할 수 있다. 자세한 배경은 `samsung-server-sdk/docs/samsung-health-integration.md` 참고.
 * ```kotlin
 * val granted = SamsungServerSdk.checkHealthDataPermission(context)
 * if (granted.values.any { !it }) {
 *     SamsungServerSdk.requestHealthDataPermission(activity)
 * }
 * val steps = SamsungServerSdk.readHealthDataSteps(context, days = 7)
 * ```
 */
object SamsungServerSdk {
    ...
    // 자세한 배경은 samsung-server-sdk/docs/samsung-health-integration.md 참고.
     ...
     *
     * @throws kr.co.hconnect.samsung_server_sdk.health.HealthDataSdkException
